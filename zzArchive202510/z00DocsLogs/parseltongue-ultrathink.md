...
- User wants to understand the architecture of a codebase
- User needs to understand dependencies and how modules relate
- User explicitly uses the 'ultrathink' keyword
- User wants to find circular dependencies or architectural issues
- User wants to understand the public API surface
