...
mod file_navigation_contract_tests {
    ...
    async fn test_entities_in_file_contract_basic_functionality() {
        ...
        let entities = provider
            .entities_in_file_with_filter("src/main.rs", None)
            .await
            .unwrap();
        ...
        let entities = provider
            .entities_in_file_with_filter("src/lib.rs", None)
            .await
            .unwrap();
        ...
        let entities = provider
            .entities_in_file_with_filter("src/nonexistent.rs", None)
            .await
            .unwrap();
    ...
    async fn test_entities_in_file_contract_type_filtering() {
        ...
        let structs = provider
            .entities_in_file_with_filter("src/main.rs", Some(EntityType::Struct))
            .await
            .unwrap();
        ...
        let structs = provider
            .entities_in_file_with_filter("src/lib.rs", Some(EntityType::Struct))
            .await
            .unwrap();
    ...
    async fn test_entities_in_file_performance_contract() {
        ...
        assert!(
            ...
            "entities_in_file_with_filter took {:?}, expected <100ms",
            elapsed
        );
    }
    ...
    async fn test_file_statistics_contract_basic_functionality() {
        ...
        let stats = provider
            .file_statistics("src/nonexistent.rs")
            .await
            .unwrap();
