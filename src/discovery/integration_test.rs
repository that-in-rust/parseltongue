...
mod tests {
    ...
    use crate::discovery::{DiscoveryEngine, DiscoveryQuery, SimpleDiscoveryEngine};
    ...
    async fn test_complete_entity_discovery_workflow() {
        ...
        let functions = engine
            .list_all_entities(Some(EntityType::Function), 100)
            .await
            .unwrap();
        ...
        let structs = engine
            .list_all_entities(Some(EntityType::Struct), 100)
            .await
            .unwrap();
        ...
        let traits = engine
            .list_all_entities(Some(EntityType::Trait), 100)
            .await
            .unwrap();
    ...
    async fn test_entity_listing_performance_validation() {
        ...
        assert!(
            list_all_time < Duration::from_millis(100),
        ...
        assert!(
            ...
            "filtered list_all_entities took {:?}, expected <100ms",
            filter_time
        );
        ...
        assert!(
            file_time < Duration::from_millis(100),
        ...
        assert!(
            lookup_time < Duration::from_millis(50),
