    ...
    if pt_path.exists() {
        ...
        #[cfg(unix)]
        {
            ...
            assert!(
                ...
                "pt script should be executable"
            );
        }
    } else {
    ...
    match output {
        Ok(output) => {
            ...
            assert!(
                ...
                "Help should mention onboard command"
            );
            assert!(
                help_text.contains("feature-start"),
                "Help should mention feature-start command"
            );
            assert!(
            ...
            assert!(
                ...
                "Help should mention refactor-check command"
            );
...
fn test_pt_onboard_subcommand() {
    ...
    let output = Command::new("./pt").arg("onboard").arg("--help").output();
...
fn test_pt_debug_subcommand() {
    ...
    let output = Command::new("./pt").arg("debug").arg("--help").output();
    ...
    match output {
        Ok(output) => {
            ...
            if output.status.success() {
                ...
                println!(
                    "pt onboard execution failed (expected in RED phase): {}",
                    stderr
                );
            }
        }
    ...
    match output {
        Ok(output) => {
            ...
            if output.status.success() {
                ...
                println!(
                    "pt feature-start execution failed (expected in RED phase): {}",
                    stderr
                );
            }
        }
    ...
    match output {
        Ok(output) => {
            ...
            if output.status.success() {
                ...
                println!(
                    "pt debug execution failed (expected in RED phase): {}",
                    stderr
                );
            }
        }
    ...
    match output {
        Ok(output) => {
            ...
            if output.status.success() {
                ...
                println!(
                    "pt refactor-check execution failed (expected in RED phase): {}",
                    stderr
                );
            }
        }
...
fn test_pt_error_handling() {
    ...
    let output = Command::new("./pt").arg("invalid-command").output();
...
fn test_pt_performance_contracts() {
    ...
    let _output = Command::new("./pt").arg("--help").output();
    ...
    if help_elapsed < std::time::Duration::from_millis(100) {
        ...
        println!(
            "pt help performance: {:?} (may need optimization)",
            help_elapsed
        );
    }
